...
try:
    from Monte_Carlo_guided_GOMOKU.mcts_alphaZero import MCTSPlayer
except Exception:
...
"""minimax depth 4
=== TOTAL RUNTIME: 772.07 s ===
Average Minimax decision time: 4984.10 ms
Average MCTS decision time:    406.02 ms

Case A: Minimax starts first (Minimax = player 1)
  Minimax wins: 21 / 24 (87.50%)
  MCTS wins:    3 / 24 (12.50%)
  Draws:        0 / 24 (0.00%)
