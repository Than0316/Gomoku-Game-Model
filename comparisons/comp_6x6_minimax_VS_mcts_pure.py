...
try:
    from Monte_Carlo_guided_GOMOKU.mcts_pure import MCTSPlayer
except Exception:
...
=== TOTAL RUNTIME: 84.56 s ===
Average Minimax decision time: 285.39 ms
Average MCTS decision time:    107.13 ms

Case A: Minimax starts first (Minimax = player 1)
  Minimax wins: 14 / 24 (58.33%)
  MCTS wins:    9 / 24 (37.50%)
  Draws:        1 / 24 (4.17%)

Case B: MCTS starts first (MCTS = player 1)
  MCTS wins:    19 / 24 (79.17%)
  Minimax wins: 5 / 24 (20.83%)
  Draws:        0 / 24 (0.00%)
  """

"""minimax search depth 4
=== TOTAL RUNTIME: 773.84 s ===
Average Minimax decision time: 4930.10 ms
Average MCTS decision time:    104.88 ms

Case A: Minimax starts first (Minimax = player 1)
  Minimax wins: 24 / 24 (100.00%)
  MCTS wins:    0 / 24 (0.00%)
  Draws:        0 / 24 (0.00%)

Case B: MCTS starts first (MCTS = player 1)
  MCTS wins:    9 / 24 (37.50%)
  Minimax wins: 15 / 24 (62.50%)
  Draws:        0 / 24 (0.00%)
"""